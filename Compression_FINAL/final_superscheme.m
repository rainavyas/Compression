function score = final_superscheme(X)
    ...
    DCT_Z = jpegdec(DCT_vlc,DCT_step,DCT_N,DCT_N,bits,huffval,8, DCT_cutoff);
    
    [LBT_vlc, bits, huffval] = LBTenc(X-128, LBT_step, LBT_s, LBT_N, LBT_N,true,8,LBT_cutoff);
