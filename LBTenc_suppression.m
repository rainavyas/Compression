function [vlc bits huffval] = LBTenc_suppression(X, qstep, s, N, M, opthuff, dcbits, cutoff)
...
% Suppress high frequency components up to cut-off
Yq = my_suppress(Yq, N, cutoff);
